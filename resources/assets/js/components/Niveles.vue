                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Ingrese nuevo nivel">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            desactivarDia(id){
                ...
                title: '¿está seguro de que quiere desactivar el nivel?',
                type: 'warning',
            ...
            activarDia(id){
                ...
                swalWithBootstrapButtons({
                title: '¿está seguro de que quiere activar el nivel?',
                type: 'warning',
                showCancelButton: true,
            ...
            validarDia(){
                ...
                if(!this.nombre) this.errorMostrarMsDia.push("El nivel no puede estar vacio.");
