            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i>Bimestre
                            ...
                            <thead>
                               <tr class="text-center ">
                                    <div class="row table-primary">
                                        ...
                                        <th class ="col-lg-4 col-md-4 col-sm-4 col-xs-12">Bimestre</th>
    ...
    export default {
        ...
        methods : {
            ...
            validarDia(){
                ...
                if(!this.nombre) this.errorMostrarMsDia.push("El bimestre no puede estar vacio.");
