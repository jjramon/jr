                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <select class="form-control col-md-4" v-model="criterio">
                                        ...
                                        <option value="nombre">Materia</option>
                                    </select>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Ingrese nueva materia">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarDia(){
                ...
                if(!this.nombre) this.errorMostrarMsDia.push("La materia no puede estar vacio.");
